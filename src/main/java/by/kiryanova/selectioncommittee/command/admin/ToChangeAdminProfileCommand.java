...
public class ToChangeAdminProfileCommand implements Command{
    private UserService receiver;

    public ToChangeAdminProfileCommand(UserService receiver){
    ...
    public Router execute(HttpServletRequest request) {
        ...
        page = PageConstant.CHANGE_ADMIN_PROFILE;
